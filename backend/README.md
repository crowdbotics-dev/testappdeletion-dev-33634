...
## Project Structure
    ...
    ├── testappdeletion_dev_33634  # Django project configurations
...
1. Clone this repo and `cd testappdeletion_dev_33634`
...
2. Clone this repo and `cd testappdeletion_dev_33634`
